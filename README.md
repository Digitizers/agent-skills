...
| [`elementor-mcp`](skills/elementor-mcp/) | Build and edit WordPress pages through the elementor-mcp server — auto-detects Elementor Pro and prefers native widgets over dumped HTML, covers MCP Adapter install and app-password auth, and asks what you want before touching the site. |
